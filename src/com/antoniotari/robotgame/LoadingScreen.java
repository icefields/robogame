...
/**
 * This screen is almost identical to the SplashLoadingScreen, 
 * except we load many more assets. As long as it takes to 
 * load these assets, our game will call the paint() method, 
 * in which we draw the splash screen image we loaded in the 
 * previous screen.
 *
 */
